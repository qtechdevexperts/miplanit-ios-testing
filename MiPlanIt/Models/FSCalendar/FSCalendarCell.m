...
- (void)layoutSubviews
{
    ...
    CGPathRef path = [UIBezierPath bezierPathWithRoundedRect:_shapeLayer.bounds
                                                        cornerRadius:11.2].CGPath;
//    CGPathRef path = [UIBezierPath bezierPathWithRoundedRect:_shapeLayer.bounds
//                                                cornerRadius:CGRectGetHeight(_shapeLayer.bounds)*0.6].CGPath;
...
- (void)configureAppearance
{
    ...
    UIColor *fillColor = self.colorForCellFill; //: [UIColor clearColor];
...
//                                                    cornerRadius:CGRectGetHeight(_shapeLayer.bounds)*0.6].CGPath;
    ...
    if (self.calendar.scope == FSCalendarScopeWeek && self.isSelected) {
         _shapeLayer.fillColor = self.colorForCellFill.CGColor;
    }
    else if (![self.contentView.layer.sublayers containsObject:_shapeLayer] ) {
        _shapeLayer.fillColor = [UIColor whiteColor].CGColor;
    }
   // [_shapeLayer setHidden:weekMode];
