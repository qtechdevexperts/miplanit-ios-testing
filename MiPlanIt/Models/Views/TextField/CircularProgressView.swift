...
@objc public enum CircularProgressViewGlowMode: Int {
...
public class CircularProgressView: UIView, CAAnimationDelegate {
    ...
    public var glowMode: CircularProgressViewGlowMode = .forward {
        didSet {
    ...
    private class CircularProgressViewLayer: CALayer {
        ...
        var glowMode: CircularProgressViewGlowMode = .forward
        ...
        private enum GlowConstants {
            ...
            static func glowAmount(forAngle angle: Double, glowAmount: CGFloat, glowMode: CircularProgressViewGlowMode, size: CGFloat) -> CGFloat {
                switch glowMode {
                case .forward:
