...
public struct Style {
    ...
    public var timeHourSystem: TimeHourSystem = .twelveHour
...
public struct HeaderScrollStyle {
    ...
    public var isDotNeeded: Bool = true
...
public struct MonthStyle {
    ...
    public var colorDate: UIColor = .black
    public var colorNameDay: UIColor = .black
    public var fontNameDate: UIFont = UIFont(name: Fonts.SFUIDisplayRegular, size: 18)!//.boldSystemFont(ofSize: 16)
    public var colorCurrentDate: UIColor = .white
    public var colorBackgroundCurrentDate: UIColor = .red
    public var colorBackgroundSelectDate: UIColor = .black
    public var colorSelectDate: UIColor = .white
    ...
    public var fontEventBullet: UIFont = .boldSystemFont(ofSize: 9 * UIScreen.main.scale)
    ...
    public var colorBackgroundWeekendDate: UIColor = gainsboro.withAlphaComponent(0.4)
    public var colorBackgroundDate: UIColor = .grayMT//.white -- done
...
public struct AllDayStyle {
    public var backgroundColor: UIColor = .clear//.gray
    public var titleText: String = "All-Day"
    public var titleColor: UIColor = .white//.black
    public var textColor: UIColor = .white//.black
...
extension Style {
    var checkStyle: Style {
        ...
        if #available(iOS 13.0, *) {
            ...
            // header
            newStyle.headerScroll.colorBackground = UIColor.clear
            ...
            newStyle.headerScroll.colorCurrentDate = .systemGray
            ...
            // week
            newStyle.week.colorBackground = UIColor.clear
